...
#   
#   expect_true(all.equal(result$w, decomp_w))
#   expect_true(all.equal(result$h, decomp_h))
#   expect_true(all.equal(result$th, decomp_th))
#   expect_true(all.equal(result$w_cor_map, match_cor_w))
#   expect_true(all.equal(result$h_cor_map, match_cor_h))
#   expect_true(all.equal(result$w_marker_map, match_marker_w))
#   expect_true(all.equal(result$h_marker_map, match_marker_h))
# })
# 
# 
