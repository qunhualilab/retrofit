...
```{r, data}
data("vignette_simulation")
x = vignette_simulation$n10m3_x
```
...
H           = vignette_simulation$iter_4k_results$decomposed$h
W           = vignette_simulation$iter_4k_results$decomposed$w
Theta       = vignette_simulation$iter_4k_results$decomposed$th
################################################################################
...
```{r, reference}
sc_ref_w = vignette_simulation$sc_ref_w
```
...
```{r, annotate}
K         = 10
result  = retrofit::annotate_by_correlations(sc_ref=sc_ref_w, K=K, 
                                             decomp_w=W, decomp_h=H)
H_annot = result$h
W_annot = result$w
ranked_cells        = result$ranked_cells
ranked_correlations = result$ranked_correlations
```
...
```{r, visualize_rmse}
H_True=vignette_simulation$sc_ref_h
H=H_annot
