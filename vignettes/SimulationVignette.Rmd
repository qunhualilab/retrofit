...
```{r, data}
data("vignetteSimulationObj")
x = vignetteSimulationObj$n10m3_x
```
...
H           = vignetteSimulationObj$results_4k_iterations$decompose$h
W           = vignetteSimulationObj$results_4k_iterations$decompose$w
Theta       = vignetteSimulationObj$results_4k_iterations$decompose$th
################################################################################
# The above results are obtained by running the code below.
# iterations = 4000
# result      = decompose(x, L=L, iterations=iterations, verbose=TRUE)
################################################################################
```
...
```{r, reference}
sc_ref_w = vignetteSimulationObj$sc_ref_w
```
...
```{r, visualize_rmse}
H_true  = vignetteSimulationObj$sc_ref_h
H_est   = H_annotated
