...
```
The code above assigns components to the cell type it has maximum correlation with. In this manner, all cell types in the reference will now be mapped to a component from RETROFIT. Here, H_annotated represents your cell type proportions for K = 10 cell types in S = 1000 spots.
